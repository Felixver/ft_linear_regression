...
# Measures how far a set of numbers is spread out from the average (mean)
...
def main():
	...
	mean_mileage = sum(data_set['km']) / len(data_set['km'])
	mean_price = sum(data_set['price']) / len(data_set['price'])
